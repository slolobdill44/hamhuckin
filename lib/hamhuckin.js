function gameStart() {
  ...
  function spawnHammo(x, y) {
    ...
    if (t.vertices) {
      ...
      // Concave polygons become compound bodies — Matter draws the sprite per
      // sub-part. Suppress that and draw the sprite once at the parent below.
  ...
  Array.prototype.forEach.call(pickerScreen.querySelectorAll('[data-throwable]'), function(btn) {
