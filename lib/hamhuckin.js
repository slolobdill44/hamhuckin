  ...
  document.onkeydown = function (keys) {
    if (keys.keyCode === 32) {
      ...
      if (whackerFrozen) {
        ...
        // Kill any pent-up velocity that whackerFreeze was rigidly suppressing,
        // so removing it doesn't release a coiled-spring pop into the whacker.
        Matter.Body.setVelocity(whacker, { x: 0, y: 0 });
