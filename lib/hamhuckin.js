function gameStart() {
  ...
  var tableTop = Matter.Bodies.rectangle(750, 500, 355, 35, {
                        chamfer: { radius: [25, 25, 25, 25] },
                        render: { sprite: { texture: 'assets/tabletop.png', yOffset: 0.1 }, lineWidth: 0 }
                    });
  var leftLeg = Matter.Bodies.rectangle(605, 565, 20, 110, {
                        render: { sprite: { texture: 'assets/tableleg.png' }, lineWidth: 0 }
                    });
  var rightLeg = Matter.Bodies.rectangle(895, 565, 20, 130, {
                        render: { sprite: { texture: 'assets/tableleg.png' }, lineWidth: 0 }
                    });
