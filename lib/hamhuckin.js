...
function gameStart() {
  ...
  var TABLETOP_WIDTH = CHEAT_MODE ? 700 : 355;
  var LEG_INSET = 17;  // distance from tabletop edge to leg center
  ...
  // Gates the afterUpdate loop so settled-hammo detection doesn't fire while
  // the world is sitting idle behind the title overlay.
  var pickingNew = true;
  ...
  Events.on(engine, "afterUpdate", function() {
    ...
    // Round-end resolution: wait at least 1.5s after the last shot landed and
